...
gPats = [
  ...
  [ "He's a tour de force on the big bad bass!",
    "Careful, holstein's secret weapon is playing the brown note on his bass!",
    "holstein holds a trademark on 'It just works' and '<anything> won't give up the funk'."]],

  [r'(.*)_guitarman_(.*)\\?',
  [ "He's one bad mother...<someone yells> Watch your mouth!</>...but I'm talking about _guitarman_!",
    "He has OPs in this channel so don't make him angry.",
    "_guitarman_ calls BS on you AND your questions!"]],

  [r'(.*)end of the world(.*)\\?',
  [ "The end of the world is January 19th, 2038. Thank a lot UNIX!",]],

  [r'(.*)podcast(.*)',
  [ "You could vist http://opensourcemusician.com and see if the answer is there."]],
  ...
  [ "How does being %1 make you feel?",
    ...
    "Why would you tell me you're %1?",
    "Why would you think you're %1?"]],
